...
<head>
    ...
    <link rel="stylesheet" crossorigin href="/dist/theme.css?v=bQWESyIWwde9lccEGUJUvPbzXmIw1EHJ855FZ8IXJkE" media="print" onload="this.media='all'">
...
<footer>
    <div class="container">
        <time datetime="2026-04-26T23:32:22.6841953Z">
