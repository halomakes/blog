...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), s = (e, i, o, s) => {
	...
	function _e(e) {
		if (Array.isArray(e.begin)) {
			...
			if (typeof e.beginScope != "object" || e.beginScope === null) throw W("beginScope must be object"), q;
			J(e, e.begin, { key: "beginScope" }), e.begin = C(e.begin, { joinWith: "" });
		}
	}
	function ve(e) {
		if (Array.isArray(e.end)) {
			if (e.skip || e.excludeEnd || e.returnEnd) throw W("skip, excludeEnd, returnEnd not compatible with endScope: {}"), q;
			if (typeof e.endScope != "object" || e.endScope === null) throw W("endScope must be object"), q;
			J(e, e.end, { key: "endScope" }), e.end = C(e.end, { joinWith: "" });
		}
	}
	function ye(e) {
	...
	function Y(e) {
		return e ? e.endsWithParent || Y(e.starts) : !1;
	}
	function Se(e) {
		return e.variants && !e.cachedVariants && (e.cachedVariants = e.variants.map(function(t) {
			return a(e, { variants: null }, t);
		})), e.cachedVariants ? e.cachedVariants : Y(e) ? a(e, { starts: e.starts ? a(e.starts) : null }) : Object.isFrozen(e) ? a(e) : e;
	}
	var Ce = "11.11.1", we = class extends Error {
		constructor(e, t) {
			super(e), this.name = "HTMLInjectionError", this.html = t;
		}
	}, X = i, Z = a, Te = Symbol("nomatch"), Ee = 7, Q = function(e) {
		...
		function d(e) {
			...
			if (n) {
				let t = N(n[1]);
				return t || (G(s.replace("{}", n[1])), G("Falling back to no-highlight mode for this block.", e)), t ? n[1] : "no-highlight";
			}
		...
		function v(e, n, i, a) {
			...
			let O = xe(D), k = "", A = a || O, j = {}, M = new l.__emitter(l);
			w();
		...
		for (let e in V) typeof V[e] == "object" && n(V[e]);
		return Object.assign(e, V), e;
	}, $ = Q({});
	$.newInstance = () => Q({}), t.exports = $, $.HighlightJS = $, $.default = $;
})))())).default, l = "[A-Za-z$_][0-9A-Za-z$_]*", u = /* @__PURE__ */ "as.in.of.if.for.while.finally.var.new.function.do.return.void.else.break.catch.instanceof.with.throw.case.default.try.switch.continue.typeof.delete.let.yield.const.class.debugger.async.await.static.import.from.export.extends.using".split("."), d = [
	"true",
	"false",
	"null",
	"undefined",
	"NaN",
	"Infinity"
], f = /* @__PURE__ */ "Object.Function.Boolean.Symbol.Math.Date.Number.BigInt.String.RegExp.Array.Float32Array.Float64Array.Int8Array.Uint8Array.Uint8ClampedArray.Int16Array.Int32Array.Uint16Array.Uint32Array.BigInt64Array.BigUint64Array.Set.Map.WeakSet.WeakMap.ArrayBuffer.SharedArrayBuffer.Atomics.DataView.JSON.Promise.Generator.GeneratorFunction.AsyncFunction.Reflect.Proxy.Intl.WebAssembly".split("."), p = [
	"Error",
	"EvalError",
	"InternalError",
	"RangeError",
...
function _(e) {
	let t = e.regex, n = (e, { after: t }) => {
		...
		built_in: g,
		"variable.language": h
	}, c = "[0-9](_?[0-9])*", _ = `\\.(${c})`, v = "0|[1-9](_?[0-9])*|0[0-7]*[89][0-9]*", y = {
		className: "number",
		variants: [
			{ begin: `(\\b(${v})((${_})|\\.)?|(${_}))[eE][+-]?(${c})\\b` },
			{ begin: `\\b(${v})\\b((${_})\\b|\\.)?|(${_})\\b` },
	...
	let D = [].concat(T, b.contains), O = D.concat([{
		begin: /(\s*)\(/,
		end: /\)/,
		keywords: s,
...
//#endregion
//#region src/components/code-snippet.ts
var y = new Map([
	["javascript", _],
	["js", _],
	["powershell", v],
	...
	static selector = ".code-snippet";
	static initializedLanguages = [];
	code;
	constructor(e) {
		let t = e.lastElementChild;
		if (!t) return;
		this.code = t.innerText;
		let n = t.lang;
		this.highlightCode(n, t), this.setupCopyButton(e);
	}
	highlightCode(t, n) {
		t && y.has(t) && (e.initializedLanguages.includes(t) || (e.initializedLanguages.push(t), c.registerLanguage(t, y.get(t))), c.highlightElement(n));
	}
	setupCopyButton(e) {
		let t = e.querySelector("[data-action=copy]");
		t && t.addEventListener("click", () => this.copy());
	}
	async copy() {
...
var I = class e {
	...
	constructor(e) {
		this.element = e, this.element.querySelector("a.selected")?.addEventListener("click", (e) => this.toggle(e));
	}
	toggle(t) {
